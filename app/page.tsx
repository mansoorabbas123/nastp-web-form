  ...
  <div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <p className="text-[#00308F] mb-4 text-sm">
        Note: Please submit your updated CV, qualification copies and CNIC (front & back) to trg.coord.khrn@nastp.gov.pk for course registration. Contact +92 308 8045070 for further information.
      </p>
        {/* Submit */}
        <button
          disabled={loading}
